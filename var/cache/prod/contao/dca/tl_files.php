...
$GLOBALS['TL_DCA']['tl_files'] = array(
    // Config
    'config' => array('dataContainer' => \Contao\DC_Folder::class, 'enableVersioning' => \true, 'databaseAssisted' => \true, 'uploadPath' => $GLOBALS['TL_CONFIG']['uploadPath'] ?? \Contao\System::getContainer()->getParameter('contao.upload_path'), 'editableFileTypes' => $GLOBALS['TL_CONFIG']['editableFiles'] ?? \Contao\System::getContainer()->getParameter('contao.editable_files'), 'onload_callback' => array(array('tl_files', 'checkPermission'), array('tl_files', 'addBreadcrumb'), array('tl_files', 'adjustPalettes')), 'oncreate_version_callback' => array(array('tl_files', 'createVersion')), 'onrestore_version_callback' => array(array('tl_files', 'restoreVersion')), 'sql' => array('keys' => array(
        'id' => 'primary',
        'pid' => 'index',
        'uuid' => 'unique',
        'path' => 'index',
    ...
    // List
    'list' => array('sorting' => array('panelLayout' => 'search'), 'global_operations' => array('sync' => array('href' => 'act=sync', 'class' => 'header_sync', 'button_callback' => array('tl_files', 'syncFiles')), 'toggleNodes' => array('href' => 'tg=all', 'class' => 'header_toggle', 'showOnSelect' => \true), 'all' => array('href' => 'act=select', 'class' => 'header_edit_all', 'attributes' => 'onclick="Backend.getScrollOffset()" accesskey="e"')), 'operations' => array('edit' => array('href' => 'act=edit', 'icon' => 'edit.svg', 'button_callback' => array('tl_files', 'editFile')), 'copy' => array('href' => 'act=paste&amp;mode=copy', 'icon' => 'copy.svg', 'attributes' => 'onclick="Backend.getScrollOffset()"', 'button_callback' => array('tl_files', 'copyFile')), 'cut' => array('href' => 'act=paste&amp;mode=cut', 'icon' => 'cut.svg', 'attributes' => 'onclick="Backend.getScrollOffset()"', 'button_callback' => array('tl_files', 'cutFile')), 'delete' => array('href' => 'act=delete', 'icon' => 'delete.svg', 'attributes' => 'onclick="if(!confirm(\'' . ($GLOBALS['TL_LANG']['MSC']['deleteConfirmFile'] ?? \null) . '\'))return false;Backend.getScrollOffset()"', 'button_callback' => array('tl_files', 'deleteFile')), 'show' => array('href' => 'act=show', 'icon' => 'show.svg', 'button_callback' => array('tl_files', 'showFile')), 'source' => array('href' => 'act=source', 'icon' => 'editor.svg', 'button_callback' => array('tl_files', 'editSource')), 'upload' => array('href' => 'act=move&amp;mode=2', 'icon' => 'new.svg', 'button_callback' => array('tl_files', 'uploadFile')), 'drag' => array('icon' => 'drag.svg', 'attributes' => 'class="drag-handle" aria-hidden="true"', 'button_callback' => array('tl_files', 'dragFile')))),
    // Palettes
    ...
    // Fields
    'fields' => array('id' => array('sql' => "int(10) unsigned NOT NULL auto_increment"), 'pid' => array('sql' => "binary(16) NULL"), 'tstamp' => array('sql' => "int(10) unsigned NOT NULL default 0"), 'uuid' => array('sql' => "binary(16) NULL"), 'type' => array('sql' => "varchar(16) NOT NULL default ''"), 'path' => array('eval' => array('unique' => \true, 'versionize' => \false), 'sql' => "varchar(1022) BINARY NOT NULL default ''"), 'extension' => array('sql' => "varchar(16) BINARY NOT NULL default ''"), 'hash' => array('sql' => "varchar(32) NOT NULL default ''"), 'lastModified' => array('sql' => "int(13) unsigned NULL default NULL"), 'found' => array('sql' => "char(1) NOT NULL default '1'"), 'name' => array('exclude' => \true, 'inputType' => 'text', 'eval' => array('mandatory' => \true, 'versionize' => \false, 'maxlength' => 255, 'decodeEntities' => \true, 'tl_class' => 'w50'), 'load_callback' => array(array('tl_files', 'addFileLocation')), 'save_callback' => array(array('tl_files', 'checkFilename')), 'sql' => "varchar(255) BINARY NOT NULL default ''"), 'protected' => array('exclude' => \true, 'input_field_callback' => array('tl_files', 'protectFolder'), 'eval' => array('tl_class' => 'w50 clr')), 'syncExclude' => array('exclude' => \true, 'input_field_callback' => array('tl_files', 'excludeFolder'), 'eval' => array('tl_class' => 'w50')), 'importantPartX' => array('exclude' => \true, 'inputType' => 'text', 'eval' => array('rgxp' => 'digit', 'nospace' => \true, 'tl_class' => 'w50 clr'), 'sql' => "DOUBLE unsigned NOT NULL default 0"), 'importantPartY' => array('exclude' => \true, 'inputType' => 'text', 'eval' => array('rgxp' => 'digit', 'nospace' => \true, 'tl_class' => 'w50'), 'sql' => "DOUBLE unsigned NOT NULL default 0"), 'importantPartWidth' => array('exclude' => \true, 'inputType' => 'text', 'eval' => array('rgxp' => 'digit', 'nospace' => \true, 'tl_class' => 'w50 clr'), 'sql' => "DOUBLE unsigned NOT NULL default 0"), 'importantPartHeight' => array('exclude' => \true, 'inputType' => 'text', 'eval' => array('rgxp' => 'digit', 'nospace' => \true, 'tl_class' => 'w50'), 'sql' => "DOUBLE unsigned NOT NULL default 0"), 'meta' => array('exclude' => \true, 'inputType' => 'metaWizard', 'eval' => array('allowHtml' => \true, 'multiple' => \true, 'metaFields' => array('title' => 'maxlength="255"', 'alt' => 'maxlength="255"', 'link' => array('attributes' => 'maxlength="2048"', 'dcaPicker' => \true), 'caption' => array('type' => 'textarea'), 'license' => array('attributes' => 'maxlength="255"', 'dcaPicker' => \true, 'rgxp' => '#(^$|^{{link_url::.+$|^https?://.+$)#', 'rgxpErrMsg' => &$GLOBALS['TL_LANG']['tl_files']['licenseRgxpError']))), 'sql' => "blob NULL")),
);
/**
...
class tl_files extends \Contao\Backend
{
    ...
    public function adjustPalettes(\Contao\DataContainer $dc)
    {
        ...
        if ($blnIsFolder) {
            \Contao\CoreBundle\DataContainer\PaletteManipulator::create()->removeField('meta')->applyToPalette('default', $dc->table);
        }
        // Only show the important part fields for images
        if ($blnIsFolder || !\in_array(\strtolower(\substr($dc->id, \strrpos($dc->id, '.') + 1)), \Contao\System::getContainer()->getParameter('contao.image.valid_extensions'))) {
            \Contao\CoreBundle\DataContainer\PaletteManipulator::create()->removeField(array('importantPartX', 'importantPartY', 'importantPartWidth', 'importantPartHeight'))->applyToPalette('default', $dc->table);
        }
    }
    /**
    ...
    public function createVersion($table, $pid, $version, $data)
    {
        ...
        if ($model === \null || !\in_array($model->extension, \Contao\StringUtil::trimsplit(',', \strtolower($GLOBALS['TL_DCA'][$table]['config']['editableFileTypes'] ?? $GLOBALS['TL_CONFIG']['editableFiles'] ?? \Contao\System::getContainer()->getParameter('contao.editable_files'))))) {
            return;
        }
        ...
        $this->Database->prepare("UPDATE tl_version SET data=? WHERE pid=? AND version=? AND fromTable=?")->execute(\serialize($data), $pid, $version, $table);
    }
    /**
    ...
    public function restoreVersion($table, $pid, $version, $data)
    {
        ...
        $objData = $this->Database->prepare("SELECT data FROM tl_version WHERE fromTable=? AND pid=? AND version=?")->limit(1)->execute($table, $pid, $version);
    ...
    public function deleteFile($row, $href, $label, $title, $icon, $attributes)
    {
        ...
        if ($finder->hasResults()) {
            return $security->isGranted(\Contao\CoreBundle\Security\ContaoCorePermissions::USER_CAN_DELETE_RECURSIVELY) ? '<a href="' . $this->addToUrl($href . '&amp;id=' . $row['id']) . '" title="' . \Contao\StringUtil::specialchars($title) . '"' . $attributes . '>' . \Contao\Image::getHtml($icon, $label) . '</a> ' : \Contao\Image::getHtml(\preg_replace('/\\.svg$/i', '_.svg', $icon)) . ' ';
        }
        return $security->isGranted(\Contao\CoreBundle\Security\ContaoCorePermissions::USER_CAN_DELETE_FILE) ? '<a href="' . $this->addToUrl($href . '&amp;id=' . $row['id']) . '" title="' . \Contao\StringUtil::specialchars($title) . '"' . $attributes . '>' . \Contao\Image::getHtml($icon, $label) . '</a> ' : \Contao\Image::getHtml(\preg_replace('/\\.svg$/i', '_.svg', $icon)) . ' ';
    }
    /**
    ...
    public function editSource($row, $href, $label, $title, $icon, $attributes)
    {
        ...
        /** @var DC_Folder $dc */
        $dc = \func_num_args() <= 12 ? \null : \func_get_arg(12);
        if (!\in_array($objFile->extension, $dc->editableFileTypes ?? \Contao\StringUtil::trimsplit(',', \strtolower($GLOBALS['TL_DCA']['tl_files']['config']['editableFileTypes'] ?? $GLOBALS['TL_CONFIG']['editableFiles'] ?? \Contao\System::getContainer()->getParameter('contao.editable_files'))))) {
