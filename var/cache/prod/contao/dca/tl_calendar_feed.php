...
$GLOBALS['TL_DCA']['tl_calendar_feed'] = array(
    ...
    // Fields
    'fields' => array('id' => array('sql' => "int(10) unsigned NOT NULL auto_increment"), 'tstamp' => array('sql' => "int(10) unsigned NOT NULL default 0"), 'title' => array('exclude' => \true, 'search' => \true, 'inputType' => 'text', 'eval' => array('mandatory' => \true, 'maxlength' => 255, 'tl_class' => 'w50'), 'sql' => "varchar(255) NOT NULL default ''"), 'alias' => array('exclude' => \true, 'search' => \true, 'inputType' => 'text', 'eval' => array('mandatory' => \true, 'rgxp' => 'alias', 'unique' => \true, 'maxlength' => 255, 'tl_class' => 'w50 clr'), 'save_callback' => array(array('tl_calendar_feed', 'checkFeedAlias')), 'sql' => "varchar(255) BINARY NOT NULL default ''"), 'language' => array('exclude' => \true, 'search' => \true, 'filter' => \true, 'inputType' => 'text', 'eval' => array('mandatory' => \true, 'maxlength' => 32, 'tl_class' => 'w50'), 'sql' => "varchar(32) NOT NULL default ''"), 'calendars' => array('exclude' => \true, 'search' => \true, 'inputType' => 'checkbox', 'options_callback' => array('tl_calendar_feed', 'getAllowedCalendars'), 'eval' => array('multiple' => \true, 'mandatory' => \true), 'sql' => "blob NULL"), 'format' => array('exclude' => \true, 'filter' => \true, 'inputType' => 'select', 'options' => array('rss' => 'RSS 2.0', 'atom' => 'Atom'), 'eval' => array('tl_class' => 'w50'), 'sql' => "varchar(32) NOT NULL default 'rss'"), 'source' => array('exclude' => \true, 'inputType' => 'select', 'options' => array('source_teaser', 'source_text'), 'reference' => &$GLOBALS['TL_LANG']['tl_calendar_feed'], 'eval' => array('tl_class' => 'w50'), 'sql' => "varchar(32) NOT NULL default 'source_teaser'"), 'maxItems' => array('exclude' => \true, 'inputType' => 'text', 'eval' => array('mandatory' => \true, 'rgxp' => 'natural', 'tl_class' => 'w50'), 'sql' => "smallint(5) unsigned NOT NULL default 25"), 'feedBase' => array('exclude' => \true, 'search' => \true, 'inputType' => 'text', 'eval' => array('trailingSlash' => \true, 'rgxp' => \Contao\CoreBundle\EventListener\Widget\HttpUrlListener::RGXP_NAME, 'decodeEntities' => \true, 'maxlength' => 255, 'tl_class' => 'w50'), 'load_callback' => array(array('tl_calendar_feed', 'addFeedBase')), 'sql' => "varchar(255) NOT NULL default ''"), 'description' => array('exclude' => \true, 'search' => \true, 'inputType' => 'textarea', 'eval' => array('style' => 'height:60px', 'tl_class' => 'clr'), 'sql' => "text NULL"), 'imgSize' => array('label' => &$GLOBALS['TL_LANG']['MSC']['imgSize'], 'exclude' => \true, 'inputType' => 'imageSize', 'reference' => &$GLOBALS['TL_LANG']['MSC'], 'eval' => array('rgxp' => 'natural', 'includeBlankOption' => \true, 'nospace' => \true, 'helpwizard' => \true, 'tl_class' => 'w50'), 'options_callback' => array('contao.listener.image_size_options', '__invoke'), 'sql' => "varchar(255) NOT NULL default ''")),
);
/**
            ...
            if ($this->User->inherit != 'custom') {
                ...
                while ($objGroup->next()) {
                    ...
                    if (\is_array($arrCalendarfeedp) && \in_array('create', $arrCalendarfeedp)) {
                        ...
                        $this->Database->prepare("UPDATE tl_user_group SET calendarfeeds=? WHERE id=?")->execute(\serialize($arrCalendarfeeds), $objGroup->id);
                    }
                }
            }
            // Add the permissions on user level
            if ($this->User->inherit != 'group') {
                $objUser = $this->Database->prepare("SELECT calendarfeeds, calendarfeedp FROM tl_user WHERE id=?")->limit(1)->execute($this->User->id);
                ...
                if (\is_array($arrCalendarfeedp) && \in_array('create', $arrCalendarfeedp)) {
                    ...
                    $arrCalendarfeeds[] = $insertId;
                    $this->Database->prepare("UPDATE tl_user SET calendarfeeds=? WHERE id=?")->execute(\serialize($arrCalendarfeeds), $this->User->id);
                }
            }
