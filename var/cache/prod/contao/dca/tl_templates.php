...
$GLOBALS['TL_DCA']['tl_templates'] = array(
    // Config
    'config' => array('dataContainer' => \Contao\DC_Folder::class, 'uploadPath' => 'templates', 'editableFileTypes' => 'html5,twig', 'closed' => \true, 'onload_callback' => array(array('tl_templates', 'adjustSettings'), array('tl_templates', 'addBreadcrumb'))),
    // List
    'list' => array('global_operations' => array('new' => array('href' => 'act=paste&amp;mode=create', 'class' => 'header_new_folder'), 'new_tpl' => array('href' => 'key=new_tpl', 'class' => 'header_new'), 'toggleNodes' => array('href' => 'tg=all', 'class' => 'header_toggle', 'showOnSelect' => \true), 'all' => array('href' => 'act=select', 'class' => 'header_edit_all', 'attributes' => 'onclick="Backend.getScrollOffset()" accesskey="e"')), 'operations' => array('edit' => array('label' => &$GLOBALS['TL_LANG']['tl_files']['edit'], 'href' => 'act=edit', 'icon' => 'edit.svg'), 'copy' => array('label' => &$GLOBALS['TL_LANG']['tl_files']['copy'], 'href' => 'act=paste&amp;mode=copy', 'icon' => 'copy.svg', 'attributes' => 'onclick="Backend.getScrollOffset()"'), 'cut' => array('label' => &$GLOBALS['TL_LANG']['tl_files']['cut'], 'href' => 'act=paste&amp;mode=cut', 'icon' => 'cut.svg', 'attributes' => 'onclick="Backend.getScrollOffset()"'), 'delete' => array('label' => &$GLOBALS['TL_LANG']['tl_files']['delete'], 'href' => 'act=delete', 'icon' => 'delete.svg', 'attributes' => 'onclick="if(!confirm(\'' . ($GLOBALS['TL_LANG']['MSC']['deleteConfirmFile'] ?? \null) . '\'))return false;Backend.getScrollOffset()"'), 'source' => array('label' => &$GLOBALS['TL_LANG']['tl_files']['source'], 'href' => 'act=source', 'icon' => 'editor.svg', 'button_callback' => array('tl_templates', 'editSource')), 'compare' => array('href' => 'key=compare', 'icon' => 'diffTemplate.svg', 'button_callback' => array('tl_templates', 'compareButton')), 'drag' => array('label' => &$GLOBALS['TL_LANG']['tl_files']['cut'], 'icon' => 'drag.svg', 'attributes' => 'class="drag-handle" aria-hidden="true"', 'button_callback' => array('tl_templates', 'dragFile')))),
    // Palettes
    'palettes' => array('default' => 'name'),
    // Fields
    'fields' => array('name' => array('label' => &$GLOBALS['TL_LANG']['tl_files']['name'], 'inputType' => 'text', 'load_callback' => array(array('tl_templates', 'addFileLocation')), 'eval' => array('mandatory' => \true, 'maxlength' => 64, 'spaceToUnderscore' => \true, 'tl_class' => 'w50'))),
);
/**
...
<div id="tl_buttons">
<a href="' . $this->getReferer(\true) . '" class="header_back" title="' . \Contao\StringUtil::specialchars($GLOBALS['TL_LANG']['MSC']['backBTTitle']) . '" accesskey="b" onclick="Backend.getScrollOffset()">' . $GLOBALS['TL_LANG']['MSC']['backBT'] . '</a>
</div>
...
<div class="tl_submit_container">
  <button type="submit" name="create" id="create" class="tl_submit" accesskey="s">' . $GLOBALS['TL_LANG']['tl_templates']['newTpl'] . '</button>
    ...
    public function editSource($row, $href, $label, $title, $icon, $attributes)
    {
        /** @var DC_Folder $dc */
        $dc = \func_num_args() <= 12 ? \null : \func_get_arg(12);
        $arrEditableFileTypes = $dc->editableFileTypes ?? \Contao\StringUtil::trimsplit(',', \strtolower($GLOBALS['TL_DCA']['tl_templates']['config']['editableFileTypes'] ?? $GLOBALS['TL_CONFIG']['editableFiles'] ?? \Contao\System::getContainer()->getParameter('contao.editable_files')));
