...
$GLOBALS['TL_LANG']['XPL']['insertTags'][0][1] = 'Więcej informacji na temat edytora TinyMCE znajdziesz na <a href="https://www.tiny.cloud/tinymce/" target="_blank" rel="noreferrer noopener">1https://www.tiny.cloud/tinymce/</a>.';
$GLOBALS['TL_LANG']['XPL']['insertTags'][1][0] = 'Wstawianie tagów';
$GLOBALS['TL_LANG']['XPL']['insertTags'][1][1] = 'Więcej informacji na temat insert tagów znajdziesz na <a href="https://docs.contao.org/dev/framework/insert-tags/" target="_blank" rel="noreferrer noopener">https://docs.contao.org/dev/framework/insert-tags/</a>.';
