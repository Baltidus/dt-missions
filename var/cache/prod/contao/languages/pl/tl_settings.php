...
$GLOBALS['TL_LANG']['tl_settings']['gdMaxImgWidth'][1] = 'Wprowadź maksymalną długość dla obrazka, którą biblioteka GD powinna przetworzyć.';
$GLOBALS['TL_LANG']['tl_settings']['gdMaxImgHeight'][0] = 'Maksymalna wysokość obrazka GD';
$GLOBALS['TL_LANG']['tl_settings']['gdMaxImgHeight'][1] = 'Wprowadź maksymalną wysokość dla obrazka, którą biblioteka GD powinna przetworzyć.';
