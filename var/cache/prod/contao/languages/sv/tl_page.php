...
// vendor/contao/core-bundle/src/Resources/contao/languages/sv/tl_page.xlf
...
$GLOBALS['TL_LANG']['tl_page']['urlPrefix'][1] = 'Ange ett URL-prefix (t.ex. språket) som kommer att läggas till alias för denna rotsida.';
...
$GLOBALS['TL_LANG']['tl_page']['guests'][1] = 'Dölj sidan om en medlem är inloggad.';
...
$GLOBALS['TL_LANG']['tl_page']['start'][1] = 'Om du vill förhindra att sidan visas på webbplatsen före ett visst datum / tid kan du ange den här. Lämna annars fältet tomt.';
$GLOBALS['TL_LANG']['tl_page']['stop'][0] = 'Sluta visa fr.o.m';
$GLOBALS['TL_LANG']['tl_page']['stop'][1] = 'Om du vill förhindra att sidan visas på webbplatsen efter ett visst datum / tid kan du ange den här. Lämna annars fältet tomt.';
...
$GLOBALS['TL_LANG']['tl_page']['copyChilds'] = 'Kopiera sidan med ID %s tillsammans med ev. undersidor';
$GLOBALS['TL_LANG']['tl_page']['delete'] = 'Ta bort sidan med ID %s';
$GLOBALS['TL_LANG']['tl_page']['toggle'] = 'Publicera / avpublicera sidan med ID %s';
...
$GLOBALS['TL_LANG']['tl_page']['legacyRouting'] = 'Inaktivera äldre routing-läge för att aktivera denna konfiguration.';
