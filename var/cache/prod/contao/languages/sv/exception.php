...
// vendor/contao/core-bundle/src/Resources/contao/languages/sv/exception.xlf
...
$GLOBALS['TL_LANG']['XPT']['errorExplain'] = 'Skriptkörningen avbröts, eftersom något inte fungerar korrekt. Själva felmeddelandet döljs av detta meddelande av säkerhetsskäl och finns i den aktuella loggfilen (se ovan). Om du inte förstår felmeddelandet eller inte vet hur du åtgärdar problemet, besök <a href="https://to.contao.org/support" target="_blank" rel="noreferrer noopener">Contaos supportsida</a>.';
...
$GLOBALS['TL_LANG']['XPT']['tokenExplainTwo'] = 'För mer information, besök <a href="https://to.contao.org/support" target="_blank" rel="noreferrer noopener">Contaos supportsida</a>.';
