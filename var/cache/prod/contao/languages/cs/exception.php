...
// vendor/contao/core-bundle/src/Resources/contao/languages/cs/exception.xlf
...
$GLOBALS['TL_LANG']['XPT']['errorExplain'] = 'Spouštění skriptu bylo pozastaveno, protože něco nefunguje správně. Daná chybová zpráva je skrytá u této poznámky z bezpečnostních důvodů a lze ji najít v souboru (viz výš). Pokud nerozumíte chybové zprávě nebo nevíte, jak lze daný problém opravit, navštivte <a href="https://to.contao.org/support" target="_blank" rel="noreferrer noopener">stránku podpory Contaa</a>.';
...
$GLOBALS['TL_LANG']['XPT']['tokenExplainTwo'] = 'Více informací najdete na <a href="https://to.contao.org/support" target="_blank" rel="noreferrer noopener">stránce podpory Contaa</a>.';
...
$GLOBALS['TL_LANG']['XPT']['missingRouteParameters']['parameterName'] = 'Název';
