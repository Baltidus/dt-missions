...
// vendor/contao/core-bundle/src/Resources/contao/languages/es/explain.xlf
$GLOBALS['TL_LANG']['XPL']['insertTags'][0][0] = 'Editor rich text';
$GLOBALS['TL_LANG']['XPL']['insertTags'][0][1] = 'Para obtener más información sobre TinyMCE, visite<a href="https://www.tiny.cloud/tinymce/" target="_blank" rel="noreferrer noopener">https://www.tiny.cloud/tinymce/</a>.';
$GLOBALS['TL_LANG']['XPL']['insertTags'][1][0] = 'Etiquetas inserción';
$GLOBALS['TL_LANG']['XPL']['insertTags'][1][1] = 'Para obtener más información sobre las etiquetas de inserción, visite <a href="https://docs.contao.org/dev/framework/insert-tags/" target="_blank" rel="noreferrer noopener">https://docs.contao.org/dev/framework/insert-tags/</a>.';
$GLOBALS['TL_LANG']['XPL']['insertTags'][2][0] = 'Editor de código';
$GLOBALS['TL_LANG']['XPL']['insertTags'][2][1] = 'Para obtener más información sobre Ace, visite <a href="https://ace.c9.io" target="_blank" rel="noreferrer noopener">https://ace.c9.io</a>.';
