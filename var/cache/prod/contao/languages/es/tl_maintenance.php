...
$GLOBALS['TL_LANG']['tl_maintenance_jobs']['xml'][1] = 'Vuelve a crear los archivos XML en la carpeta <code>compartida</code> y luego purga el caché compartido, por lo que no hay enlaces a los recursos eliminados.';
