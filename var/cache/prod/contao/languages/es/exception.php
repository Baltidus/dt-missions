...
// vendor/contao/core-bundle/src/Resources/contao/languages/es/exception.xlf
...
$GLOBALS['TL_LANG']['XPT']['errorExplain'] = 'La ejecución del script se detuvo porque algo no funciona correctamente. El mensaje de error real está oculto por este aviso por razones de seguridad y se puede encontrar en el archivo de registro actual (ver arriba). Si no entiende el mensaje de error o no sabe cómo solucionar el problema, visite la <a href="https://to.contao.org/support" target="_blank" rel="noreferrer noopener">página de soporte de Contao</a>.';
...
$GLOBALS['TL_LANG']['XPT']['tokenExplainTwo'] = 'Para obtener más información, visite la <a href="https://to.contao.org/support" target="_blank" rel="noreferrer noopener">página de soporte de Contao</a>.';
