...
$GLOBALS['TL_LANG']['XPL']['insertTags'][0][1] = 'Для получения дополнительной информации о TinyMCE, посетите <a href="https://www.tiny.cloud/tinymce/" target="_blank" rel="noreferrer noopener">https://www.tiny.cloud/tinymce/</a>.';
$GLOBALS['TL_LANG']['XPL']['insertTags'][1][0] = 'Вставка тегов';
$GLOBALS['TL_LANG']['XPL']['insertTags'][1][1] = 'Для получения дополнительной информации о вставке тегов, посетите <a href="https://docs.contao.org/dev/framework/insert-tags/" target="_blank" rel="noreferrer noopener">https://docs.contao.org/dev/framework/insert-tags/</a>.';
$GLOBALS['TL_LANG']['XPL']['insertTags'][2][0] = 'Редактор кода';
$GLOBALS['TL_LANG']['XPL']['insertTags'][2][1] = 'Для получения дополнительной информации об Ace, посетите <a href="https://ace.c9.io" target="_blank" rel="noreferrer noopener">https://ace.c9.io</a>.';
