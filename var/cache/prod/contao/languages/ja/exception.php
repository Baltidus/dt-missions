...
// vendor/contao/core-bundle/src/Resources/contao/languages/ja/exception.xlf
...
$GLOBALS['TL_LANG']['XPT']['errorExplain'] = '何かが適切に動作していないため、スクリプトの実行は停止しました。この通知の実際のエラーメッセージはセキュリティ上の理由で表示していませんが、現在のログファイルにあるはずです(上記を参照)。エラーメッセージの意味がわからない場合や、この問題の修正の方法を知らない場合は<a href="https://to.contao.org/support" target="_blank" rel="noreferrer noopener">Contaoのサポートのページ</a>を参照してください。';
...
$GLOBALS['TL_LANG']['XPT']['tokenExplainTwo'] = 'さらに詳しい情報は、<a href="https://to.contao.org/support" target="_blank" rel="noreferrer noopener">Contaoのサポートのページ</a>を参照してください。';
