...
$GLOBALS['TL_LANG']['XPT']['errorExplain'] = 'Die Skriptausführung wurde gestoppt, weil irgendetwas nicht korrekt funktioniert. Die eigentliche Fehlermeldung wird aus Sicherheitsgründen hinter dieser Meldung verborgen und findet sich in der aktuellen Log-Datei (siehe oben). Wenn Sie die Fehlermeldung nicht verstehen oder nicht wissen, wie das Problem zu beheben ist, besuchen Sie die <a href="https://to.contao.org/support" target="_blank" rel="noreferrer noopener">Contao-Supportseite</a>.';
...
$GLOBALS['TL_LANG']['XPT']['tokenExplainTwo'] = 'Besuchen Sie die <a href="https://to.contao.org/support" target="_blank" rel="noreferrer noopener">Contao-Supportseite</a> für weitere Informationen.';
